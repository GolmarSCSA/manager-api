...
<head>
    ...
    <!--[if !mso]>-->
    <link
        href="https://fonts.googleapis.com/css2?family=Montserrat:wght@700&amp;family=Open+Sans:wght@400;600&amp;family=Lato:wght@400&amp;display=swap"
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <table class="t4" role="presentation"
                                                                        ...
                                                                        <tr>
                                                                            <!--[if mso]>
<td width="182" class="t3" style="width:182px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class="t3" style="width:182px;">
                                                                                <!--<![endif]-->
                                                                                <table class="t2"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="t1"
                                                                                            ...
                                                                                            <div
                                                                                                style="font-size:0px; align: center;">
                                                                                                <img class="t0"
                                                                                                    style="display:block; margin: 0 auto; border:0; height:auto; width:100%; max-width:182px;"
                                                                                                    width="182"
                                                                                                    height="59.171875"
                                                                                                    alt=""
                                                                                                    src="https://0e5bde35-8e65-4ff5-8b94-f87184e72a15.b-cdn.net/e/a49b3875-4ac7-4bef-a55f-2ce3a4274f43/55d607b5-bc12-4785-a12e-93d0e3de7fb3.png" />
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
...
<![endif]-->
                                                                            ...
                                                                            <td class="t21" style="width:514px;">
                                                                                ...
                                                                                <table class="t20"
                                                                                    ...
                                                                                    <tr>
                                                                                        <p class="t17"
                                                                                            style="font-family: Lato, BlinkMacSystemFont, Segoe UI, Helvetica Neue, Arial, sans-serif; line-height: 48px; font-weight: 400; font-style: normal; font-size: 42px; text-decoration: none; text-transform: none; letter-spacing: 10px; direction: ltr; color: #333333; text-align: center; mso-line-height-rule: exactly; mso-text-raise: 2px;">
                                                                                            {{ $code }}</p>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                                                        ...
                                                                                                        <tr
                                                                                                            ...
                                                                                                            <td class="t26"
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td class="t24"
                                                                                                                            style="background-color:#FFFFFF;text-align:left;line-height:20px;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                                                                                            <span
                                                                                                                                class="t23"
                                                                                                                                style="display:block;margin:0;Margin:0;font-family:Open Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:20px;font-weight:600;font-style:normal;font-size:14px;text-decoration:none;direction:ltr;color:#222222;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">{{ $footer }}</span>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </table>
                                                                                                            </td>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table class="t40" role="presentation"
                                                                        ...
                                                                        <tr>
                                                                            <!--[if mso]>
<td width="514" class="t39" style="background-color:#FFFFFF;width:514px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class="t39"
                                                                                style="background-color:#FFFFFF;width:514px;">
                                                                                <!--<![endif]-->
                                                                                <table class="t38"
                                                                                    role="presentation"
                                                                                    cellpadding="0" cellspacing="0"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="t37"
                                                                                            style="text-align:left;line-height:20px;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                                                            <span class="t36"
                                                                                                style="display:block;margin:0;Margin:0;font-family:Open Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:20px;font-weight:600;font-style:normal;font-size:14px;text-decoration:none;direction:ltr;color:#222222;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">Golmar
